            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm flex flex-col">
                ...
                <div className="p-4 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => window.open('/api/cases/export', '_blank')}
                            className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl text-xs font-bold text-gray-700 hover:bg-gray-50 hover:text-blue-600 hover:border-blue-100 transition-all shadow-sm group"
                        >
                        ...
                        <div className="text-xs font-bold text-gray-400 uppercase tracking-widest bg-white px-3 py-2 rounded-xl border border-gray-100 shadow-sm">
